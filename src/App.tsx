      ...
      const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "system",
              content: "You are 𓂀 AnonX AI 𓂀, a mysterious, intelligent, and powerful AI assistant. You are helpful but speak with an air of mystery and depth. You answer all questions clearly and helpfully but with a slightly enigmatic tone. You were created by AnonX Intelligence. Keep responses clear but intriguing.",
            },
    ...
    <div style={{
      ...
      <div style={{ width: "100%", maxWidth: 680, padding: "20px 16px 16px", borderBottom: "1px solid rgba(138,43,226,0.2)", display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, zIndex: 100, background: "rgba(0,0,0,0.95)", backdropFilter: "blur(10px)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div>
            <div style={{ fontSize: 18, fontWeight: 800, background: "linear-gradient(135deg, #8a2be2, #da70d6)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", animation: glitch ? "glitch 0.2s ease" : "glow 3s ease-in-out infinite", letterSpacing: "0.05em" }}>𝔸𝕟𝕠𝕟𝕏 𝔸𝕀</div>
